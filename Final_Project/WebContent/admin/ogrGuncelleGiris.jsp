...
try {
	...
	if(!con.isClosed()){ 	
		String sorgu="select * from ogrenciler where ogr_id="+Integer.parseInt(request.getParameter("o_id"))+"";
		session.setAttribute("ogr_id", request.getParameter("o_id"));
...
<form action="ogrGuncelle.jsp" method="post">
	<table id="customers">
	  <tr>
	    <th colspan="2">Ogrenci Bilgi Guncelleme</th>
	  </tr>
	<% while(rs.next()){ %>
		  <tr>
		    <td>Ogrenci Ad:</td>
