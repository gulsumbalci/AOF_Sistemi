...
try {
	...
	if(!con.isClosed()){ 	
		...
		preStmt = con.prepareStatement("select * from ogrenciler");
	    rs = preStmt.executeQuery();
	    %>
	    <table id="customers">
	    <tr><th colspan="8">OGRENCI LISTESI</th></tr>
		  <tr>
		    <th>Id</th>
		    <th>Ad</th>
		    <th>T.C</th>
	    ...
	    <tr>
		    ...
		    <td><a href='ogrenciSil.jsp?o_id=<%=rs.getInt("ogr_id")%>'>Sil</a></td>
		    <td><a href='ogrGuncelleGiris.jsp?o_id=<%=rs.getInt("ogr_id")%>'>Guncelle</a></td>
	        </tr> <% }//end while %>
